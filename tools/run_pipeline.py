#!/usr/bin/env python3
"""
GTA Static Recompilation Pipeline

Orchestrates: PE analysis -> disassembly -> function discovery -> lifting -> C output
Uses pcrecomp tools from D:/recomp/pc/tools/
"""
...
def generate_recomp_files(functions, iat_map, output_dir, split_size=1000, func_names=None):
    ...
    while func_idx < total:
        ...
        with open(filepath, 'w') as f:
            f.write(f"/* Auto-generated by GTA recompiler -- DO NOT EDIT */\n")
...
def main():
    parser = argparse.ArgumentParser(description='GTA Static Recompilation Pipeline')
